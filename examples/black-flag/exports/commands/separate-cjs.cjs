 ...
 */
module.exports.builder = function (blackFlag, _, argv) {
 ...
 */
module.exports.command = '$0 <name> <id>';

/**
 * @type {import('@black-flag/core').ChildConfiguration['description']}
 */
module.exports.description = 'Add a new remote';
 ...
 */
module.exports.usage = `${defaultUsageText}.
